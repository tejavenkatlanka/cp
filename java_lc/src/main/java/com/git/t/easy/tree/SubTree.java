...
public class SubTree {
    public boolean isSubtree(TreeNode s, TreeNode t) {
        if (s == null || t == null) return t == null;
    ...
    private boolean isMatched(TreeNode sNode, TreeNode tNode) {
        if (sNode == null || tNode == null) return sNode == tNode;
        return  sNode.val==tNode.val && isMatched(sNode.left,tNode.left) &&isMatched(sNode.right,tNode.right);
    }
